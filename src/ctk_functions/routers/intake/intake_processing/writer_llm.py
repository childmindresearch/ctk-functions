...
- DO NOT USE MARKDOWN SYNTAX, i.e. do not use headers with #, do not use lists with -, or quotes with >, or any similar syntax. All text will be placed directly into a Word document as plain text and as such, will be directly integrated with its surroundings.
"""  # noqa: E501
